...
const agentAllData = async()=>{
   const res = await fetch('/valorantagents.json')
   return res.json();
  }

 const agentPromises = agentAllData();
      ...
      <div className='max-w-[1400px] mx-auto '>
        <div className="navbar bg-base-100 shadow-sm ">
          ...
          <div className="navbar-center">
            <a className="btn btn-ghost text-xl">Valorant Agent</a>
          </div>
      ...
      <footer className="footer footer-horizontal footer-center bg-primary text-primary-content p-10">
        <aside>
          ...
          <p className="font-bold">
            FHK Industries Ltd.
            <br />
            Providing reliable gaming information.
          </p>
